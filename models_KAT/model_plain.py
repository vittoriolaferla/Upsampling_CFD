...
from models_KAT.select_network import define_G
from models_KAT.model_base import ModelBase
from models_KAT.loss import CharbonnierLoss
from models_KAT.loss_ssim import SSIMLoss

from utils.utils_SwinIR.utils_model import test_mode
from utils.utils_SwinIR.utils_regularizers import regularizer_orth, regularizer_clip
from models_KAT.Umass import Umass,DifferentiableRGBtoVel
...
class ModelPlain(ModelBase):
    ...
    def init_train(self):
        ...
        self.log_dict['G_loss'] = 0.0         # Initialize G loss in log
    ...
    def feed_data(self, data, need_H=True):
        ...
        if data['CSV'] is not None:
            self.CSV = data['CSV'].to(self.device)
    ...
    def optimize_parameters(self, current_step):
        ...
        if self.opt_train['use_umass_loss']:
            ...
            self.log_dict['Umass_loss'] = umass_loss.item()
