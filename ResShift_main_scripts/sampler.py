...
class ResShiftSampler(BaseSampler):
    ...
    def inference(self, in_path, out_path, vel_path, mask_path=None, mask_back=True, bs=1, noise_repeat=False):
        '''
        Inference demo.
        Input:
        ...
        vel_path = Path(vel_path) if not isinstance(vel_path, Path) else vel_path
